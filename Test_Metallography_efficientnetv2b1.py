...
# Load the model
model = load_model("c:/python/metallography_230205/efficientnetv2b1/model.h5", compile=False)

# Load the labels
class_names = open("c:/python/metallography_230205/efficientnetv2b1/labels.txt", "r").readlines()
# 改行コードを取り除く
...
for f in fname:
    ...
    normalized_image_array = tf.keras.applications.efficientnet.preprocess_input(image_array)
