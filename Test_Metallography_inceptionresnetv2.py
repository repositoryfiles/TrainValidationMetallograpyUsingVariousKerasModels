...
# Load the model
model = load_model("c:/python/metallography_230205/inceptionresnetv2/model.h5", compile=False)

# Load the labels
class_names = open("c:/python/metallography_230205/inceptionresnetv2/labels.txt", "r").readlines()
# 改行コードを取り除く
